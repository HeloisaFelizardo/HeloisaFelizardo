...
[![My Skills](https://skillicons.dev/icons?i=vscode,eclipse,idea,js,html,css,sass,vite,react,express,prisma,npm,figma,bootstrap,docker,java,spring,gradle,maven,postgres,mongodb,git,github)](https://skillicons.dev)
